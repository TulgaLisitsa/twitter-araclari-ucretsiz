...
if (isset($_SESSION["araclar"])) { ?>
	...
	<head>
		...
		<title>Ayarlar | vasdej.com</title>
	              ...
	              <div class="row">
	                ...
	                <div class="col-md-12">
	                          <div class="card">
	                            ...
	                            $querys = $db->query("SELECT * FROM ayarlar", PDO::FETCH_ASSOC);
	                                    ...
	                                    <div class="row">
	                                        <div class="col-md-6">
	                                            <div class="form-group">
	                                                ...
	                                                <input style="font-size:15px;"type="text"name="kadi" class="form-control"value="<?php echo $row["kadi"]; ?>">
	                                            </div>
	                                        </div>
	                                        <div class="col-md-6">
	                                            <div class="form-group">
	                                                <label>Şifre</label>
	                                                <input style="font-size:15px;"type="text"name="sifre" class="form-control" value="<?php echo $row["sifre"]; ?>">
	                                            </div>
	                                        </div>
	                                    </div>
	                                      ...
	                                      <div class="row">
	                                          <div class="col-md-6">
	                                              <div class="form-group">
	                                                  <label>Comuser_Key</label>
	                                                  <input style="font-size:15px;"type="text"name="comsur" class="form-control"value="<?php echo $row["key1"]; ?>">
	                                              </div>
	                                          </div>
	                                          <div class="col-md-6">
	                                              <div class="form-group">
	                                                  <label>comuser_secret</label>
	                                                  <input style="font-size:15px;" type="text"name="secret" class="form-control" value="<?php echo $row["key_secret"]; ?>">
	                                              </div>
	                                          </div>
	                                      </div>
	                                      ...
	                                      <div class="row">
	                                          <div class="col-md-12">
	                                              ...
	                                              <input style="font-size:15px;" type="submit" value="Güncelle" class="btn btn-info btn-fill col-md-12">
	                                              </div>
	                                          </div>
