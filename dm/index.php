                                          ...
                                          <div class="col-md-4">
                                              <form action="ekle.php"method="POST">
                                                <div class="form-group">
                                                  <!-- See also: https://codepen.io/raubarrera/pen/VejpQP -->
  <textarea rows="5" name="mesaj"style="font-size:15px;height:100px;" class="form-control" placeholder="Mesajınızı Giriniz" ></textarea>
                                                </div>
                                          </div>
                                          <div class="col-md-4">
                                              <div class="form-group">
    ...
    <?php } ?>
                          ...
                          <div class="row" >
                            <div class="col-md-12">
                              ...
                              $query = $db->query("SELECT * FROM dm", PDO::FETCH_ASSOC);
