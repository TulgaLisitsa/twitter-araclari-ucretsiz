...
<head>
	...
	<title>Hesaplar | vasdej.com</title>
              ...
              -->
                                          ...
                                          <div class="col-md-4">
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <input style="font-size:20px;" type="text"name="kadi" class="form-control" placeholder="Kullanıcı Adı" >
                                              </div>
                                          </div>
                                          <div class="col-md-4">
                                              <div class="form-group">

                                                  <input style="font-size:20px;" type="password"name="sifre" class="form-control" placeholder="Şifre" >
                                              </div>
                                          </div>
                                          <div class="col-md-4">
                                              <div class="form-group">
                                                        ...
                                                        <div class="content table-responsive table-full-width">
                                                            <table class="table table-hover table-striped">
                                                                <thead>
                                                                	...
                                                                	<th>Kullanıcı</th>
                                                                  <th>ilk Takipçi</th>
                                                                    <th>Kazanılan Takipçi Sayısı</th>
                                                                      <th>İşlem</th>
                                                                </tr>
                                                              </thead>
                                                                <tbody>
                                                                ...
                                                                $query = $db->query("SELECT * FROM hesap", PDO::FETCH_ASSOC);
                                                                 ...
                                                                 ?>
                                                                  ...
                                                                  <tr>
                                                                    ...
                                                                    <td><img style="border-radius:20px;margin-right:10px;" src="<?php echo $row["resim"]; ?>"><?php echo $row["kadi"]; ?></td>

                                                                    <td><?php echo $row["ilk_takipci"]; ?></td>
                                                                    <td><?php


																																			 $ilk = $row["ilk_takipci"];
																																			 $son_t = $row["son_takipci"];
																																			 $iş = $son_t - $ilk;
																																			 echo "+ $iş Takipçi Kazandı";
