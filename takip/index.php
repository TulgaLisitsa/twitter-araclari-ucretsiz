...
<div class="wrapper">
              ...
              -->
                                          ...
                                          <div class="col-md-3">
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <input style="font-size:20px;" type="text"name="kadi" class="form-control" placeholder="Takip Edilecek Kullanıcı" >
                                              </div>
                                          </div>
                                          <div class="col-md-3">
    ...
    <span class="custom-select">
      <select name="islem" >
        <option  value="1" selected>Takip Ettiklerini</option>

        <option value="2">Takipçilerini </option>
    ...
    <?php } ?>
                          ...
                          <div class="row" >
                            <div class="col-md-12">
                              ...
                              $query = $db->query("SELECT * FROM takip", PDO::FETCH_ASSOC);
                                ...
                                foreach( $query as $row ){
                                  ...
                                  foreach ($ka as $ke) {
                                                ...
                                                <td><img style="border-radius:20px;margin-right:10px;" src="<?php echo $ke["resim"]; ?>"><?php echo $row["hesap"]; ?></td>
 <td><?php echo $row["kadi"]; ?></td>
                                                                   <td><?php

                                                                   $is = $row["islem"];
                                                                   if ($is == 1) {
                                                                     echo "Takip Ettikleri";
                                                                   }elseif ($is == 2) {
                                                                     echo "Takipçilerini";
                                                                   }else{
                                                                     echo "hata";
