...
<head>
	...
	<title>Unfollow | vasdej.com</title>
...
<div class="wrapper">
    ...
    <span class="custom-select">
      <select name="islem" >
        <option value="1">Beni Takip Etmeyenleri</option>
        <option value="2">Herkese Unfollow</option>
                            ...
                            <div class="col-md-12">
                                                    <div class="card">
                                                        <center>  <div class="header">
                                                          <h4 class="title">Unfollow LOG</h4>
                              ...
                              $query = $db->query("SELECT * FROM unfollow", PDO::FETCH_ASSOC);
                                ...
                                foreach( $query as $row ){
                                  ...
                                  foreach ($ka as $ke) {
                                                ...
                                                <td><img style="border-radius:20px;margin-right:10px;" src="<?php echo $ke["resim"]; ?>"><?php echo $row["kadi"]; ?></td>
                                                                   ...
                                                                   $is = $row["islem"];
                                                                   if ($is == 1) {
                                                                     echo "Takip Etmeyenlere";
                                                                   }elseif ($is == 2) {
                                                                     echo "Herkese";
                                                                   }else{
                                                                     echo "Herkese Unfollow";
                                                                   }
